export const quizSets = {
  survey: {
    ...
    questions: [
      {
        id: 1,
        question: "Khi thấy một người bị tai nạn nhẹ trên đường, bạn thường:",
        options: [
          "Lại gần giúp đỡ người đó.",
          "Dừng lại nhìn rồi đi tiếp.",
          "Lờ đi như không thấy gì.",
      ...
      {
        id: 2,
        question: "Nếu bạn của bạn tâm sự chuyện buồn, bạn sẽ",
        options: [
          "Lắng nghe và an ủi bạn.",
          "Nghe cho có rồi bỏ qua.",
          "Nói 'kệ đi' và lảng sang chuyện khác.",
          "Cảm thấy phiền và tránh né.",
        ],
        correctAnswer: 0,
        explanation:
      ...
      {
        id: 3,
        question: "Khi bạn thấy một bạn học bị cô lập trong lớp, bạn sẽ",
        options: [
          "Chủ động đến bắt chuyện, làm quen.",
          "Thấy rồi thôi, ai sao mặc kệ.",
          "Né tránh vì sợ bị liên lụy.",
          "Cười đùa với bạn khác về chuyện đó.",
        ],
        correctAnswer: 0,
        explanation:
      ...
      {
        id: 4,
        question: "Khi có một hoàn cảnh khó khăn được chia sẻ trong lớp, bạn",
        options: [
          "Cảm thấy xúc động và muốn quyên góp, giúp đỡ.",
          "Nghe vậy thôi chứ không quan tâm.",
          "Cảm thấy không liên quan tới mình.",
          "Thấy phiền vì cứ bị nhắc đến.",
        ],
        correctAnswer: 0,
      ...
      },
      {
        id: 5,
        question:
          "Khi làm việc nhóm, nếu có bạn làm sai hoặc không theo kịp, bạn sẽ",
        options: [
          "Hỗ trợ và động viên bạn.",
          "Phớt lờ và tự làm phần mình.",
          "Trách móc bạn đó.",
          "Muốn loại bạn khỏi nhóm.",
        ],
        correctAnswer: 0,
      ...
      },
      {
        id: 6,
        question:
          "Gặp cảnh người ăn xin hay người khuyết tật bán hàng rong, bạn",
        options: [
          "Mua ủng hộ hoặc giúp đỡ nếu có thể.",
          "Nhìn qua rồi đi tiếp.",
          "Cảm thấy khó chịu và tránh xa.",
          "Cười cợt với bạn bè.",
        ],
        correctAnswer: 0,
        explanation:
      ...
      {
        id: 7,
        question: "Khi bạn khác trong lớp được tuyên dương, bạn cảm thấy",
        options: [
          "Vui và chúc mừng bạn.",
          "Không quan tâm.",
          "Ganh tỵ và khó chịu.",
          "Coi như chuyện không đáng để ý.",
        ],
        correctAnswer: 0,
        explanation:
      ...
      {
        id: 8,
        question: "Nếu thấy một bạn bị ngất xỉu ở trường, bạn sẽ",
        options: [
          "Gọi giáo viên và sơ cứu nếu biết cách.",
          "Đứng nhìn vì không biết làm gì.",
          "Bỏ đi vì nghĩ không phải việc mình.",
          "Quay video hoặc chụp ảnh lại.",
        ],
        correctAnswer: 0,
        explanation:
      ...
      {
        id: 9,
        question: "Khi đọc hoặc xem tin về những hoàn cảnh bất hạnh, bạn",
        options: [
          "Cảm thấy xúc động và muốn giúp",
          "Xem qua rồi quên ngay",
          "Cảm thấy 'chuyện của người ta, không liên quan'",
          "Lướt qua không cần xem",
        ],
        correctAnswer: 0,
      ...
      {
        id: 10,
        question: "Một bạn trong lớp hay ngồi một mình, buồn bã, bạn sẽ",
        options: [
          "Tới hỏi thăm, rủ bạn tham gia cùng lớp.",
          "Để bạn ấy yên vì không thân.",
          "Cho rằng bạn đó lập dị.",
          "Bỏ mặc, không để ý.",
        ],
        correctAnswer: 0,
        explanation:
